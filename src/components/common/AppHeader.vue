<template>
  <header class="bg-dark-700 border-b border-primary-500/30 h-16 flex items-center px-6 shadow-md">
    <div class="flex items-center">
      <router-link to="/" class="flex items-center">
        <div class="text-primary-400 text-2xl font-semibold tracking-wider">
          <span class="text-white">CVE</span>Explorer
        </div>
      </router-link>
    </div>
    ...
    <div class="flex items-center space-x-4">
      ...
      <button class="text-gray-400 hover:text-primary-400 transition">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <!-- GitHub Link -->
      <a href="https://github.com" target="_blank" class="text-gray-400 hover:text-primary-400 transition">
      ...
      <RouterLink to="login">
        <button class="text-gray-400 hover:text-primary-400 transition">Login</button>
      </RouterLink>
